...
//        wp_enqueue_script('html5blankscripts'); // Enqueue it!
        ...
        wp_register_script('pbit-script', get_template_directory_uri() . '/library/js/script.js', array('jQuery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('pbit-script'); // Enqueue it!
    }
}
...
//    wp_register_style('pbit-style', get_template_directory_uri() . '/library/css/style.css', array(), '1.0', 'all');
//    wp_enqueue_style('pbit-style'); // Enqueue it!
}
